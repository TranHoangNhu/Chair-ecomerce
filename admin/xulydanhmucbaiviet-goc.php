    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="xulybaiviet.php">Danh mục tin tức</a>
                </li>
                <li class="nav-item">
            ...
            ?>
                ...
                <div class="col-md-4">
                    ...
                    <form action="" method="post">
                        <input type="text" class="form-control" name="danhmuc" value="<?php echo $row_capnhat['danhmuc_tin_name']?>"><br>
