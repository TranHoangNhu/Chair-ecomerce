			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto text-center mr-xl-5">
					...
					<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
						<?php
						$sql_tin = mysqli_query($mysqli, "SELECT * FROM tbl_danhmuc_tin ORDER BY danhmuc_tin_id DESC");
						?>
						...
						<div class="dropdown-menu">
							...
							?>
								<a class="dropdown-item" href="index.php?quanly=tintuc&id=<?php echo $row_tin['danhmuc_tin_id'] ?>"><?php echo $row_tin['danhmuc_tin_name'] ?></a>
							<?php
							}
							?>
						</div>
					...
					<li class="nav-item">
						<a class="nav-link" href="index.php?quanly=thongtin">Liên hệ</a>
					</li>
				</ul>
			</div>
		</nav>
