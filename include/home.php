			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<?php 
							$sql_category_home = mysqli_query($mysqli,"SELECT * FROM tbl_category ORDER BY category_id DESC");
							while ($row_category_home = mysqli_fetch_array($sql_category_home)){
								$id_category = $row_category_home['category_id']
						?>

						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-bold"><?php echo $row_category_home['category_name'] ?></h3>
							<div class="row">
								<?php 
									$sql_sanpham = mysqli_query($mysqli,"SELECT * FROM tbl_sanpham ORDER BY sanpham_id DESC");
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php echo $row_sanpham['sanpham_image'] ?>" alt="" height="150px" width="150px">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo number_format ($row_sanpham['sanpham_giakhuyenmai']).' VND' ?><br></span>
											...
											<form action="?quanly=giohang" method="post">
												<fieldset>
													...
													<input type="hidden" name="sanphamid" value="<?php echo $row_sanpham['sanpham_id']?>" />
					...
					<div class="side-bar p-sm-4 p-3">
						<!-- <div class="search-hotel border-bottom py-2">
							...
							<form action="" method="post">
								<input type="search" placeholder="Sản phẩm..." name="timkiem_button" required="">
								<input type="submit" value="timkiem_name">
							</form>
						</div> -->
						<!-- price -->
