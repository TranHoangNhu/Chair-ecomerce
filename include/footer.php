...
<footer>
					...
					<div class="col-md-4 offer-footer">
						<div class="row">
							...
							<div class="col-8 text-form-footer">
								...
								<p>Đơn hàng trên 2,000,000 VND</p>
							</div>
						</div>
					</div>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<?php 
							$sql_category_footer = mysqli_query($mysqli,"SELECT * FROM tbl_category ORDER BY category_id DESC");
							while ($row_category_footer = mysqli_fetch_array($sql_category_footer)){
						?>
						
						<ul>
							<li class="mb-3">
								<a href="?quanly=danhmuc&id=<?php echo $row_category_footer['category_id'] ?>"><?php echo $row_category_footer['category_name'] ?> </a>
							</li>
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 97A Hồng Lạc , TPHCM</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 09 67 666 173 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> 09 67 666 173 </li>
							<li class="mb-3">
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:minhgia@gmail.com"> minhgia@gmail.com</a>
							</li>
							<li>
								<i class="fas fa-envelope-open"></i>
								<a href="mailto:thanhdanh@gmail.com"> thanhdanh@gmail.com</a>
							</li>
						</ul>
					</div>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2021 Website Bán Truyện. All rights reserved | Design by
				<a href="#">TNT</a>
			</p>
		</div>
	</div>
